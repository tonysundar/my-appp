      ...
      <div className="max-w-screen-xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600">
            ...
            With 20 years of experience, you have expertise in a wide range of technologies, including C, C++, DSA, Java Full Stack, MERN Stack, and Python Full Stack. You are associated with Sree Institute of Info Tech, where you’ve honed your skills in both foundational and advanced tech stacks.
          </p>
        </div>
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg transform hover:scale-105 hover:shadow-2xl transition duration-300 ease-in-out">
              <div className="flex justify-center mb-4">
                <img
                  src={sandeep} // Replace with the student's image
                  alt="Jane Smith"
                  className="w-24 h-24 object-cover rounded-full border-4 border-sky-400" // Circular image with border
                />
              </div>
              ...
              <p className="font-semibold text-gray-800">Sandeep</p>
